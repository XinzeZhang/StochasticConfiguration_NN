...
# load data to gpu memory
train_data = tf.cast(tf.contrib.eager.Variable(load_data['X']),tf.float32)
train_label = tf.cast(tf.contrib.eager.Variable(load_data['T']),tf.float32)

test_data = tf.cast(tf.contrib.eager.Variable(load_data['X2']),tf.float32)
test_label = tf.cast(tf.contrib.eager.Variable(load_data['T2']),tf.float32)
